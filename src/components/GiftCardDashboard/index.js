...
import classes from './GiftCardDashboard.css'
import { useGiftCardDashboard } from '@giftcard/giftcard/src/talons/useGiftCardDashboard.js'
import { redeemGiftCard } from '@giftcard/giftcard/src/talons/redeemGiftCard'
import { removeGiftCardFromList } from '@giftcard/giftcard/src/talons/removeGiftCardFromList'
import { addGiftCardToList } from '@giftcard/giftcard/src/talons/addGiftCardToList'
import { checkGiftCardCode } from '@giftcard/giftcard/src/talons/checkGiftCardCode'
import { SAVE_NOTIFICATIONS } from '@giftcard/giftcard/src/talons/GiftCard.gql'
		...
		<Fragment>
			...
			<div style={{width: '70%', margin: 'auto', outline: 'none', marginTop: '20px'}} tabIndex='0' onKeyDown={handleEscGCView}>
				...
				<div className={classes['giftcard-container']}>
					...
					<div className={classes['block-gift-card']} >
						<div className={classes.loading} 
			                style={{
			                    ...
			                    height: balanceBlockHeigt,
			                    width: balanceBlockWidth
			                }}
			            >
			                <img src={Loading}/>
			            </div>
					...
					<div className={classes['block-gift-card']} ref={gcListBlockRef}>
						<div className={classes.loading} 
			                style={{
			                    display: redeemLoading || addGcLoading || removeGcLoading ? 'flex' : 'none',
			                    height: gcListBlockHeight,
			                    width: gcListBlockWidth
			                }}
			            >
			                <img src={Loading}/>
			            </div>
					...
					<div className={classes['block-gift-card']} ref={transactionsBlockRef}>
						<div className={classes.loading} 
			                style={{
			                    display: redeemLoading ? 'flex' : 'none',
			                    height: transactionsBlockHeight,
			                    width: transactionsBlockWidth
			                }}
			            >
			                <img src={Loading}/>
			            </div>
					...
					<div className={classes['block-gift-card']} ref={notificationsBlockRef}>
						<div className={classes.loading} 
			                style={{
			                    display: saveNotificationsLoading ? 'flex' : 'none',
			                    height: notificationsBlockHeight,
			                    width: notificationsBlockWidth
			                }}
			            >
			                <img src={Loading}/>
			            </div>
